...
import { Typography, Button, Grid, TextField, CssBaseline, makeStyles, Paper } from '@material-ui/core';
...
export default function AddCard({ logout }) {
    ...
    return (
        <Grid>
            <CssBaseline />
            <Grid container direction="row" align="center" justify="space-between" m={20}>
                <Grid style={{ margin: "2%" }}>
                ...
                <Grid align="right" style={{ margin: "2%" }}>
                    <Button>
                        <Link style={{ textDecoration: "none", color: "#2f302f" }} to="/cards">
                            View Cards
                        </Link>
                    </Button>
            ...
            <Grid container component="main" className={classes.root} justify="space-around">
                <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
                    <div className={classes.paper}>
                        ...
                        <form className={classes.form} onSubmit={submitForm}>
                            <TextField type="text" fullWidth margin="normal" label="Card Number" variant="outlined" placeholder="16 digit card no." value={cardNo} onChange={(e) => setCardNo(e.target.value)} required />
                            <TextField type="text" fullWidth margin="normal" label="Expiry Date" variant="outlined" placeholder="MM/YY" value={expiryDate} onChange={(e) => setExpiryDate(e.target.value)} required />
                            <TextField type="text" fullWidth margin="normal" label="Card Holder" variant="outlined" placeholder="Name on Card" value={cardHolder} onChange={(e) => setCardHolder(e.target.value)} required />
